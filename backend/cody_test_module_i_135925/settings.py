"""
Django settings for cody_test_module_i_135925 project.
...
ROOT_URLCONF = 'cody_test_module_i_135925.urls'
...
WSGI_APPLICATION = 'cody_test_module_i_135925.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cody_test_module_i_135925 API",
    "DESCRIPTION": "API documentation for cody_test_module_i_135925 App",
    "VERSION": "v1",
}
